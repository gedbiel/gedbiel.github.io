...
function pdt360DegViewer(id, n, p, t, playable, autoPlay, draggable, mouseMove, buttons, keys, scroll) {
    ...
    if (!playable && !autoPlay) {
        ...
        if (buttons) {
            ...
            leftNavBtn.setAttribute('title', 'Kairėn');
            ...
            rightNavBtn.setAttribute('title', 'Dešinėn');
        ...
        if (playable) {
            ...
            playBtn.setAttribute('title', 'Paleisti');
            ...
            pauseBtn.setAttribute('title', 'Pauzė');
            ...
            leftBtn.setAttribute('title', 'Sukti į kairę');
            ...
            rightBtn.setAttribute('title', 'Sukti į dešinę');
            ...
            speedBtn.setAttribute('title', 'Sukti greičiau');
            ...
            slowBtn.setAttribute('title', 'Sukti lėčiau');
